...
namespace Minesweeper
{
    ...
    class Minesweeper
    {
        ...
        static readonly Dictionary<int, ConsoleColor> colorKey = new Dictionary<int, ConsoleColor>
        {
            {-1, ConsoleColor.Red},
        ...
        private static void OpenField(int x, int y)
        {
            ...
            if (x > 0
                && y > 0
                && PlayField[x - 1, y - 1].Visible == false)
            {
                OpenField(x - 1, y - 1);
            }
