...
namespace Snake
{
    class Snake
    {
        ...
        private static readonly int FieldHeight = 15;
        private static readonly int FieldWidth = 15;
        private static readonly int RefreshTime = 150;
        private static readonly FieldType[,] Field = new FieldType[FieldWidth, FieldHeight];
        private static Pos FruitPos = new Pos();
        private static readonly Pos SnakeHead = new Pos(Field.GetLength(0) / 2, Field.GetLength(1) / 2);
        private static Pos PrevSnakeHead = new Pos(Field.GetLength(0) / 2, Field.GetLength(1) / 2);
        private static readonly List<Pos> SnakeTails = new List<Pos>();
